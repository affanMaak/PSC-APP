...
`.trim();
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <ViewShot ref={viewShotRef} options={{ format: 'png', quality: 1.0 }} style={{ backgroundColor: '#f9f3eb' }}>
        ...
        {/* Action Buttons */}
        <View style={[styles.actionButtons, { paddingHorizontal: 15 }]}>
          <TouchableOpacity
            style={styles.secondaryButton}
            onPress={handleSaveToGallery}
            disabled={saveLoading}
          >
            <MaterialIcons name="file-download" size={20} color="#b48a64" />
