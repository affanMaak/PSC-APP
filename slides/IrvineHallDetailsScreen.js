...
const IrvineHallDetailsScreen = ({ navigation, route }) => {
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={styles.notchContent}>
                        ...
                        <Text style={styles.headerText}>Irvine Hall</Text>
                        <TouchableOpacity
                ...
                <SafeAreaView style={styles.safeArea}>
                    <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                        ...
                        {/* Why Our Irvine Hall Section */}
                        <View style={styles.whySection}>
                            <Text style={styles.whyTitle}>
                                WHY OUR <Text style={styles.whyTitleGold}>IRVINE HALL</Text>
                            </Text>
                            ...
                            <View style={styles.featuresGrid}>
                                ...
                                <View style={styles.featureRow}>
                                    ...
                                    <View style={styles.featureBox}>
                                        ...
                                        <Text style={styles.featureText}>28 Capacity</Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.featureRow}>
                                    <View style={styles.featureBox}>
                                        <Icon name="chatbubbles-outline" size={36} color="#A3834C" />
                                        <Text style={styles.featureText}>Panel{'\n'}Discussions</Text>
                                    </View>
                                    <View style={styles.featureBox}>
                                        <Icon name="briefcase-outline" size={36} color="#A3834C" />
                                        <Text style={styles.featureText}>Corporate{'\n'}Meetings</Text>
                                    </View>
                                    <View style={styles.featureBox}>
                                ...
                                <View style={styles.featureRow}>
                                    ...
                                    <View style={styles.featureBox}>
                                        <Icon name="cafe-outline" size={36} color="#A3834C" />
                        ...
                        <View style={styles.descriptionSection}>
                            <Text style={styles.descriptionTitle}>About Irvine Hall</Text>
                            <Text style={styles.descriptionText}>
                                It is a sophisticated sitting space suitable for panel discussions and other
                                formal meetings. The Irvine Hall offers a professional environment perfect
                                for executive meetings, interviews, and corporate discussions.
                            </Text>
                            {/* <View style={styles.capacityBadge}>
                                <Icon name="people" size={20} color="#A3834C" />
                                <Text style={styles.capacityText}>Capacity: 28 Persons</Text>
                            </View> */}
                        </View>
                        {/* Dress Code Section */}
...
export default IrvineHallDetailsScreen;
