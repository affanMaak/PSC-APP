...
const Badminton = ({ navigation }) => {
  ...
  const modalData = {
    ...
    dosAndDonts: {
      ...
      numbered: true,
      data: [
        "Members and guests are requested to bring their activity card along.",
        "Use of the Badminton Courts shall be on 'first come first serve' basis. The reception desk attendant shall monitor the court use and sign-in process and resolve any problems.",
        "Refrain from yelling, making loud sounds, and avoid gossiping in the court area.",
        "A limit of 20 minutes per pair shall be applicable for each court when there are other individuals signed-in and waiting to use the courts.",
        "All members / guests to ensure entry in ledger at reception desk before entering the courts.",
        "Any misconduct by playing member / guest will result in the cancellation of the activity card.",
        "Do not leave your bag or other personal belongings or expensive items in the absence of an instructor at the reception desk.",
        "All kinds of food items and drinks are prohibited in the badminton courts except in the lobby / reception area.",
        ...
        "Children are not allowed in the badminton courts.",
      ],
    },
  };
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.notchContent}>
            ...
            <Text style={styles.headerTitle}>Badminton</Text>
        ...
        <View style={styles.sliderContainer}>
          <Swiper
            ...
            dotColor="#D3D3D3"
          >
            <Image source={require('../assets/badminton.jpeg')} style={styles.sliderImage} />
            <Image source={require('../assets/badminton.jpeg')} style={styles.sliderImage} />
          </Swiper>
        </View>
